...
urlpatterns = [
    ...
    path("import/choose-file/", views.bank_transactions_import_choose_file, name="bank_transactions_import_choose_file"),
    path("import/commit/", views.bank_transactions_import_commit_json, name="bank_transactions_import_commit_json"),
]
