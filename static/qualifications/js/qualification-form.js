(function () {
  ...
  function deriveQualificationCode(description) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const descInput = document.getElementById("id_qualification_desc");
    const codeInput = document.getElementById("id_qualification_code");

    if (!descInput || !codeInput) {
      return;
    }

    let lastAutoCode = deriveQualificationCode(descInput.value || "");
    ...
    descInput.addEventListener("input", function () {
      const nextAutoCode = deriveQualificationCode(descInput.value || "");
