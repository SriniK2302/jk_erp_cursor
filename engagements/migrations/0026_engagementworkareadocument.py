...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("engagements", "0025_work_area_period_planned_dates_blank"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name="EngagementWorkAreaDocument",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "file",
                    models.FileField(
                        upload_to=engagements.models._engagement_work_area_document_upload_to
                    ),
                ),
